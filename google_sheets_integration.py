...
class GoogleSheetsUploader:
    ...
    def authenticate(self):
        ...
        credentials_file = self.settings.get('google_sheets', {}).get('credentials_file', 'credentials.json')
    ...
    def upload_session(self, session_data, session_id):
        ...
        try:
            ...
            print(f"Session uploaded to Google Sheets: {result.get('updates', {}).get('updatedCells', 0)} cells updated")
            return True
